...
- 打开 https://github.com/hzuapps/html5-2020 
...
```   
$ git clone https://github.com/你的帐号名/html5-2020
```   
- 进入本地项目源代码目录：  
```   
$ cd web-wechat-2019
...
- 打开资源浏览器，在项目中创建个人学号目录，如：html5-2020/students/123456/
...
- 打开个人项目库：https://github.com/你的帐号名/html5-2020 ；
